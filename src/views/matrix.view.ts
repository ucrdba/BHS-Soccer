 ...
 *
 * Converted from js/views/matrix.view.js.
 */
...
Object.assign(BHSSoccerApp.prototype, {
  ...
  renderMatrixView(this: BHSSoccerApp): string {
        ...
        <div class="matrix-grid">
          <div class="matrix-table-container">
            ...
            <table class="matrix-table">
              ...
              <tbody>
                ${(this.data.players || []).filter(p => !p.isDeleted).sort((a,b) => (a.matrixStats?.rank || 99) - (b.matrixStats?.rank || 99)).map(p => `
                  <tr>
                    <td>
