...
import QuizAttemptsSection from '../components/admin/QuizAttemptsSection.vue';
...
<template>
  <section class="admin">
    ...
    <QuizAttemptsSection
      v-if="isCoach"
      :team-id="org.activeTeamId" data-admin-quiz-attempts />
...
.admin__title { font-family: var(--heading-face); font-weight: 500; font-size: 24px; color: var(--mark); }
