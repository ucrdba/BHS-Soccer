...
Object.assign(BHSSoccerApp.prototype, {
  ...
  compareMatrixPlayers(a, b, by) {
    return window.csvDomain.compareMatrixPlayers(a, b, by);
  },
  ...
  pickColumn(row, aliases) {
    return window.csvDomain.pickColumn(row, aliases);
  },
   ...
   * cost a record.
   */
  // CSV reading lives in src/domain/csv.ts.
  parseCsvText(text) {
    return window.csvDomain.parseCsvText(text);
  },
